...
list(
  ...
  tar_target(rr_attrition_gsheet,
             "1EyUGgw8uGaCIP9nLXKh3IwqqU4DoAM4ZV6K5i1dOTHo"),
  tar_target(rr_attrition_moddate,
             get_google_mod_date(rr_attrition_gsheet),
             cue = tar_cue("always")),
  tar_target(rr_attrition,
             read_google_sheet(rr_attrition_gsheet,
                               rr_attrition_moddate,
                               sheet = "sourced",
                               drop_cols = "indicator")),
...
list(
  tar_target(pubs_updated,
             update_pubs(publications_raw,
                         pub_changelog)),
  
  tar_target(publications,
             transform_pubs(pubs_updated,
                            top_factor)),
