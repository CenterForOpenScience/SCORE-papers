...
list(
  ...
  # Processed ----
  tar_target(claims_p1,
             transform_p1_ces(tagtable_p1)),
  
  tar_target(claims_covid,
             transform_covid_ces(tagtable_covid_p1)),
  
  tar_target(claims_p2,
             transform_p2_ces(tagtable_p2_CES)),
