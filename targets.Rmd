...
list(
  ...
  # changes_repro_supplement.csv ----
  # Change log for reproduction supplemental variables
  tar_target(changes_repro_supplement_file,
             "e498m"),
  tar_target(changes_repro_supplement_moddate,
             get_osf_mod_date(changes_repro_supplement_file),
             cue = tar_cue("always")),
  tar_target(changes_repro_supplement,
             load_osf_csv(changes_repro_supplement_file,
                          changes_repro_supplement_moddate)),
...
list(
  ...
  tar_target(rr_attempts_minted,
             update_attempts_minted(score_rr_types,
