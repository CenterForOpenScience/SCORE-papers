...
list(
  ...
  # Claims extracted from phase 1 COVID papers
  ...
  # covid_ta2.csv
  # Claims extracted from phase 1 COVID papers, but with paper IDs for TA2
  # Used for matching up paper IDs with the IDs given to TA2
...
list(
  ...
  # Reproduction summary variables
  tar_target(repro_supplementary,
             calculate_repro_summary(orig_dataset,
                                    repro_export,
                                    rr_confrontations_repro_claim)),
  
  # Repro outcomes dataset
