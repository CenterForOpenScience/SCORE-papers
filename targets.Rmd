...
library(usethis) # silly workaround to get renv to store this package
tar_unscript()
...
Original variables data from the OSF repository, [SCORE - Phase 1 RR and original article analyses](https://osf.io/3fsbm/). Note: orig_statistics_output_p2 will always throw a parsing warning, but no changes actually need to be made.
...
2) orig_statistics_output_p2: One or more parsing issues
