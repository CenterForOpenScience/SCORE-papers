...
create_repli_analytic <- function(repli_export,
  ...
  repli_outcomes <- repli_export %>%
    ...
    rename(
      ...
      repli_effect_size_text = rr_effect_size_fulltext_reported,
      repli_effect_size_type = rr_effect_size_type_reported,
      repli_effect_size_value = rr_effect_size_value_reported,
      ...
      repli_claim_supported = rr_repl_subjective_replicated_reported,
      repli_claim_support_notes = rr_repl_subjective_description_reported,
      ...
      repli_version_of_record = is_vor,
      repli_is_generalizability = is_generalizability
    ) %>%
    ...
    select(-c(rr_original_data_overlap,
              ...
              is_covid,
              rr_effect_size_type_reference,
              rr_effect_size_value_reference))
