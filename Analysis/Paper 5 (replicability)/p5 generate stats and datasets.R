# Settings
{
  folder_main_code <- paste0("Analysis/Paper 5 (replicability)/")
  folder_figures <- paste0("Analysis/Paper 5 (replicability)/Figures/")
...
if(run_knit==TRUE){
  ...
  if (save_figures == TRUE){
    ...
    for (figure in names(results_figures)){
      ...
      # bundled_ggplot <- results_figures[[figure]]
      # ggplot2::ggsave(
      #   file=paste0(figure,".tiff"),
