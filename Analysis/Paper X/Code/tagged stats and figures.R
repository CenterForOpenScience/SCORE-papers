...
# Run tag generation
{
  ...
  # Run tagged stats
    ...
    # Generate stats
      values_text <- tagged_stats(iters = 100,repli_outcomes_default_subset(),orig_outcomes,df.papers=NA)
    ...
    tags_output <- data.frame(tags,values_text)
    
  # Export
    sheet_write(tags_output, ss="https://docs.google.com/spreadsheets/d/1iIBhBsbvz89sZCDRFn9wghh17RExMa5XxQPLhlB_Bt8")
